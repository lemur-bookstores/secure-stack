        ...
        const { features } = await inquirer.prompt([
            {
                ...
                choices: [
                    { name: 'Authentication (@lemur-bookstores/secure-stack-auth)', value: 'auth', checked: true },
                    { name: 'RBAC (@lemur-bookstores/secure-stack-rbac)', value: 'rbac', checked: true },
                    { name: 'Service Mesh (@lemur-bookstores/secure-stack-mesh)', value: 'mesh', checked: true },
                    { name: 'Rate Limiting (@lemur-bookstores/secure-stack-rate-limit)', value: 'rate-limit', checked: false },
                    { name: 'Audit Logging (@lemur-bookstores/secure-stack-audit)', value: 'audit', checked: false },
                    { name: 'Cache (@lemur-bookstores/secure-stack-cache)', value: 'cache', checked: false },
                    { name: 'Storage (@lemur-bookstores/secure-stack-storage)', value: 'storage', checked: false },
                ],
            },
        ]);
        return features;
